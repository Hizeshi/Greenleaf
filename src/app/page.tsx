...
const faq: FaqItem[] = [
  {
    ...
    a: "Два пути на выбор. Быстрый: напишите мне в WhatsApp или Telegram — соберу корзину за вас и оформлю вам товар в любую точку мира с функцией «оплаты при получении» или в любой посёлок по почте. Самостоятельный: перейдите в каталог по ссылке с этого сайта, зарегистрируйтесь за минуту и заказывайте, пользуясь всеми привилегиями, акциями и скидками, в любое время.",
  },
  {
    q: "Почему через вас дешевле?",
    a: "В Siberian Wellness регистрация по моей ссылке делает вас Привилегированным клиентом: цены ниже розничных до 25% плюс бонусные баллы с каждого заказа. В Greenleaf публичных реферальных ссылок нет — скидку 50% на весь товар, пожизненно, оформлю вам лично в чате за пару минут. И то и другое бесплатно и ни к чему не обязывает.",
  },
  {
  ...
  },
  {
    ...
    a: "Да, отправляю заказы в любую точку мира: курьерской службой с оплатой при получении или почтой — даже в небольшой посёлок. Сроки зависят от региона, обычно от 2 до 10 дней.",
  },
];
          ...
          <div>
            ...
            <Reveal delay={0.1}>
              <p className="mt-6 leading-relaxed text-ink-soft">
                Несколько лет назад я сама искала работающие витамины и
                безопасную химию для дома — и утонула в маркетинге. С тех пор я
                разобралась в составах, перепробовала десятки продуктов и
                оставила в своей практике только те, что действительно работают.
              </p>
              ...
              <TiltCard className="group h-full">
                ...
                >
                  <div>
                    ...
                    <p className="mt-5 inline-block rounded-full bg-gold/15 px-4 py-1.5 text-sm font-semibold text-gold">
                      Клубные цены до −25%
                    </p>
                  </div>
                ...
                >
                  <div>
                    ...
                    <p className="mt-3 leading-relaxed text-ink-soft">
                      Бытовая химия-концентраты, косметика и парфюмерия, средства
                      гигиены, товары для детей и текстиль из бамбука.
                    </p>
                    <div className="mt-6 flex flex-wrap gap-2">
                      {["дом и уборка", "косметика", "детям", "бамбук"].map((tag) => (
                        <span
                          key={tag}
                    ...
                    <p className="mt-5 inline-block rounded-full bg-forest/10 px-4 py-1.5 text-sm font-semibold text-forest">
                      −50% при регистрации — навсегда
                    </p>
                  </div>
