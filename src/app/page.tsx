...
const faq: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Регистрация по ссылке открывает клубные условия производителя. В каталоге Greenleaf вы сразу получаете скидку 50% на весь товар — пожизненно. В Siberian Wellness — цены ниже розничных до 25% плюс бонусные баллы с каждого заказа. Для вас это бесплатно и ни к чему не обязывает.",
  },
  {
